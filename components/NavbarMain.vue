      ...
      <div class="flex items-start xs:h-2.5">
        ...
        >
          ...
          <nuxt-link
            ...
            class="text-white block font-semibold leading-5 mb-1.5 hover:text-yellow-1"
          >
            Services & Solutions
          </nuxt-link>
          ...
          <p
            ...
            @click="$store.dispatch('setSection', 8)"
          >
            Super Deals
          </p>
        </div>
        <div
          ...
          :class="{ 'navbar__hidden-element': isNavbarHidden }"
        >
          <p class="text-white font-semibold leading-5 mb-1.5 hover:text-yellow-1" @click="$store.dispatch('setSection', 6)">Technologies</p>
          <p
            class="text-white font-semibold leading-5 mb-1.5 hover:text-yellow-1"
            @click="$store.dispatch('setSection', 7)"
          >
            Processes
          </p>
          <p
            class="text-white font-semibold leading-5 mb-1.5 hover:text-yellow-1"
            @click="$store.dispatch('setSection', 9)"
          >
            Reviews
          </p>
        </div>
